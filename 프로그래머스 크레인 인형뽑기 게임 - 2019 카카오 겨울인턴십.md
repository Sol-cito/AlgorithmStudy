## 프로그래머스 크레인 인형뽑기 게임 - 2019 카카오 겨울인턴십
...
인형을 뽑아 담는 곳이 바로 스택이다.

peek으로 본 stack의 최상단 인형과 add할 인형이 같으면 그냥 pop하여 인형을 사라지게 하고, count해나가면 되는 쉬운 문제다.

stack을 처음 접하는 사람들이 stack 자료구조를 연습하기 딱 좋을 것 같다.
